...
EasySMPC requires [Java](https://www.java.com), at least in version 13. TODO: If our
packaging to be bundles the JDK, delete this paragraph.
...
As EasySMPC developed to allow easy, privacy-preserving analysis in a medical
context, we show how to perform a joint calculation between three institutes to
get the number of patients with various diseases. This example uses manual
message sending, see the other examples or the documentation for an automated
approach.

### 1. Initalization of study

#### Party A: Fill out study details

#### Party A: Enter own values

#### Party A: Send initial message to all participants

#### Party B+C: Enter recieved message

### 2. Secretshare own values

#### Party B+C: Enter own Values

#### Party B+C: Send messages to all participants

#### Party A+B+C: Enter recieved messages

### 3. Recombine result

#### Party A+B+C: Send result message

#### Party A+B+C: Enter recieved result message

#### Party A+B+C: Export clear text result
