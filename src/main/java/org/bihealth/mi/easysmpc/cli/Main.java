...
public class Main {
    ...
    public static ConnectionIMAPSettings getConnectionIMAPSettingsFromCLI(CommandLine cli) {
        ...
        ConnectionIMAPSettings connectionIMAPSettings = new ConnectionIMAPSettings(cli.getOptionValue(OPTION_MAILADDRESS_RECEIVING),
                                                                                   null, cli.hasOption(OPTION_MAILADDRESS_SENDING) ? cli.getOptionValue(OPTION_MAILADDRESS_SENDING) : cli.getOptionValue(OPTION_MAILADDRESS_RECEIVING)).setIMAPPassword(cli.getOptionValue(OPTION_PASSWORD_RECEIVING))
