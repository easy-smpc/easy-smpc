...
/**
 * A model for redacted content in matrix
 * 
 * @author Felix Wirth
 *
 */
...
public class RedactedBecause {
     ...
     * @param content
     */
    public RedactedBecause(Content content, Long originServerTs, String redacts, String sender, String type, Unsigned unsigned, String eventId) {
        super();
