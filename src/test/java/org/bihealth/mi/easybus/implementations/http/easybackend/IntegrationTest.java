...
public class IntegrationTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ConnectionSettingsEasyBackend settingsReceiver = new ConnectionSettingsEasyBackend(receiver.getIdentifier(), null)
        ...
        ConnectionSettingsEasyBackend settingsSender = new ConnectionSettingsEasyBackend(sender.getIdentifier(),
                                                                                         null)
                .setAPIServer(new URL("http://127.0.0.1:8080"))
                .setRealm("easybackend")
                .setClientId("easy-client");
